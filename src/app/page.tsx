          ...
          <div className="relative z-10 max-w-2xl mx-auto px-6">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 px-4 py-3 rounded-md bg-black border border-white/20 focus:outline-none focus:border-accent-primary focus:ring-1 focus:ring-accent-primary text-white font-mono placeholder:text-zinc-600 transition-all"
                required
              />
              <button
                type="submit"
                className="px-6 py-3 rounded-md bg-white text-black font-semibold hover:bg-zinc-200 transition-colors whitespace-nowrap"
              >
                Request Access
              </button>
            </form>
